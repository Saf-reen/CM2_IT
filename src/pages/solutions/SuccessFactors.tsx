...
const SuccessFactors = () => {
    ...
    const implementationSteps = [
        {
            title: "Advisory & Roadmap Services",
            bullets: [
                "HR Transformation Consulting: Align HR strategy with business goals",
                "Readiness Assessment: Evaluate current systems and processes for cloud HR transition",
                "Roadmap Design: Phased implementation planning across SuccessFactors modules",
            ],
        },
        {
        ...
        },
        {
            ...
            bullets: [
                "SAP S/4HANA integration (via SAP BTP or SAP CPI)",
                "Third-party system integrations (payroll, benefits, etc.)",
                "API-based integrations",
            ],
        },
        {
            title: "Post-Go-Live Support & AMS",
            bullets: [
                "Hypercare Support: Intensive support post go-live",
                "Application Management Services (AMS): Ticket-based and SLA-driven support model",
                "Release Management: Continuous updates and testing for biannual SAP releases",
            ],
        },
        {
            title: "Training & Change Management",
            bullets: [
                "End User Training: Role-based training with quick guides, videos, and LMS",
                "Change Management Support: Communication plans, stakeholder alignment, and training adoption",
            ],
        },
        {
            title: "Enhancement & Optimization",
            bullets: [
                "Process Automation: Using SAP Build Process Automation or BTP Workflow",
                "Custom UI Enhancements: Fiori-based extensions or BTP UI5 apps",
                "Analytics Dashboards: Tailored dashboards via People Analytics",
            ],
        },
        {
            title: "Migration to SuccessFactors from Legacy Systems",
            bullets: [
