    ...
    const implementationSteps = [
        {
            ...
            bullets: [
                "Current landscape assessment (ECC or other ERPs)",
                "Fit-gap analysis for S/4HANA",
                "TCO & ROI modeling",
                "PCE vs Public Cloud vs On-Prem comparison",
            ],
        },
        {
            title: "Greenfield / Brownfield / Selective Data Transition",
            bullets: [
        ...
        {
            title: "System Provisioning & Landscape Design",
            bullets: [
                "PCE environment setup (DEV, QAS, PRD)",
                "HA/DR setup and backup planning",
                "Landscape sizing and performance optimization",
            ],
        },
        {
        ...
        },
        {
            ...
            bullets: [
                "Legacy data cleansing, mapping & transformation",
                "Use of SAP Migration Cockpit or 3rd-party tools",
                "Data validation and reconciliation",
            ],
        },
        {
            title: "Extensibility & Custom Development",
            bullets: [
        ...
        },
        {
            ...
            bullets: [
                "Unit, integration, and UAT support",
                "Test automation",
        ...
        },
        {
            ...
            bullets: [
                ...
                "Basis support, patching, and upgrades",
...
export default SAPPrivateCloud;
