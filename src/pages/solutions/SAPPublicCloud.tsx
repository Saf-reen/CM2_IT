    ...
    const implementationSteps = [
        {
            ...
            bullets: [
                ...
                "Landscape assessment and cloud readiness check",
            ],
        },
        {
            title: "Initial System Setup",
            bullets: [
                "Tenant provisioning and system access",
                "Identity and access management (IAM)",
                "Organizational structure and master data setup",
            ],
        },
        {
        ...
        },
        {
            ...
            bullets: [
                "Data cleansing, mapping & transformation",
                "Use of SAP Migration Cockpit or templates",
        ...
        },
        {
            ...
            bullets: [
                "SAP BTP-based integrations (SAP Integration Suite)",
                "Standard APIs and iFlows (SAP API Hub)",
                "Non-SAP system integrations (CRM, PLM, eCommerce)",
            ],
        },
        ...
        },
        {
            ...
            bullets: [
                ...
                "Role-based documentation and eLearning modules",
            ],
        },
        {
        ...
        {
            title: "Extensibility Development",
            bullets: [
                "In-app extensibility (custom fields, logic)",
                "Side-by-side extensions via SAP BTP (CAP, RAP)",
            ],
        },
         {
