        ...
        <div className="min-h-screen bg-background overflow-x-hidden">
            ...
            <HeroSection
                title={
                    ...
                    >
                        Transform with<br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary via-blue-400 to-secondary animate-gradient-x">
                            RISE with SAP
                        </span>
                    </motion.div>
                }
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="group px-8 py-4 bg-secondary text-white font-bold rounded-full hover:bg-white hover:text-primary transition-all duration-300 shadow-[0_0_40px_rgba(14,165,233,0.4)] flex items-center gap-2 justify-center"
                        >
                            Get Started
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="px-8 py-4 bg-white/10 backdrop-blur-md text-white font-bold rounded-full border border-white/30"
                        >
                            Learn More
                        </motion.button>
                    </div>
                    ...
                    {/* Quick Stats */}
                    <div className="grid grid-cols-3 gap-8 md:gap-16 pt-4 border-t border-white/10 mt-4">
                        {[
