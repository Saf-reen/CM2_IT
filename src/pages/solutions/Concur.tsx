    ...
    const implementationSteps = [
        {
            ...
            bullets: [
                "Needs Assessment & Fit-Gap Analysis",
                "Solution Design & Configuration",
                "Training & Change Management",
                "Global Rollout Strategy (multi-country compliance, localization, currencies)",
            ],
        },
        {
            title: "Travel Management Services",
            bullets: [
                "Travel Booking Automation: Enable clients to book flights, hotels, and car rentals within policy using Concur Travel",
                "Travel Policy Enforcement: Configure rules and workflows to ensure compliance.",
                "Integration with Travel Partners: Seamlessly connect with airlines, hotels, and GDS systems",
                "Mobile App Support: Empower employees to manage bookings and itineraries on the go",
            ],
        },
        {
            title: "Expense Management Services",
            bullets: [
                "Automated Expense Reporting: Simplify submission and approval with Concur Expense",
                "OCR & Receipt Capture: Use AI to scan and populate data from receipts",
                "Policy Compliance: Configure automatic policy checks and flag violations",
                "Integration with Credit Cards: Auto-import transactions for reconciliation",
            ],
        },
        {
            title: "Invoice Management Services",
            bullets: [
                "Automated AP Processing: Capture, route, and pay vendor invoices using Concur Invoice",
                "Supplier Portal Enablement: Provide tools for suppliers to manage their invoices",
                "3-Way Matching: Ensure PO, receipt, and invoice alignments",
                "Fraud Detection & Audit Trails: Built-in controls and audit logs",
            ],
        },
        {
            title: "Integration Services",
            bullets: [
                "ERP Integration: Connect SAP Concur with SAP S/4HANA (or ECC) for real-time financial visibility",
                "HR System Integration: Sync employee data from SAP SuccessFactors or other HRMS",
                "Custom API Integrations: Build tailored integrations with third-party apps and analytics tools",
            ],
        },
        {
            title: "Analytics & Reporting",
            bullets: [
                "Dashboards & KPIs: Track travel spend, expense trends, and vendor usage",
                "Audit & Compliance Reports: Support for internal/external audits",
                "AI-Driven Insights: Identify cost-saving opportunities and policy violations",
            ],
        },
        {
