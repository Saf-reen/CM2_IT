    ...
    const implementationSteps = [
        {
            ...
            bullets: [
                "Warehouse process assessment and gap analysis",
                "EWM readiness checks",
                "Roadmap creation for SAP EWM implementation or migration (e.g., from WM to EWM)",
                "Fit-gap analysis for embedded vs. decentralized EWM",
            ],
        },
        {
            title: "EWM Implementation & Configuration",
            bullets: [
                "End-to-end SAP EWM greenfield or brownfield implementations",
                "Embedded EWM on S/4HANA or decentralized EWM setup",
                "Customizing warehouse structure (storage types, bins, sections, activity areas)",
                "Integration with ERP (SAP MM, SD, PP, QM)",
            ],
        },
        {
            ...
            bullets: [
                "SAP S/4HANA or ECC",
                "Material Flow Systems (MFS) for automation",
                "RFID/barcode scanning solutions",
                "Transportation Management (TM), Yard Logistics, and Labor Management",
            ],
        },
        {
            title: "Advanced EWM Functionalities",
            bullets: [
                "Slotting and rearrangement",
                "Wave and labor management",
                "Cross-docking, value-added services (VAS), kitting",
        ...
        },
        {
            ...
            bullets: [
                ...
                "Custom reports and analytics (e.g., WH productivity, order status dashboards)",
                "Integration with non-SAP systems (WMS, MES, TMS)",
            ],
        },
        {
            title: "Testing, Training & Change Management",
            bullets: [
                "Key user and end-user training",
                "UAT and scenario-based testing",
                "Change impact analysis and process documentation",
            ],
        },
        {
            ...
            bullets: [
                "Hypercare support",
                "Continuous improvement via KPI monitoring",
                "Warehouse process automation and performance tuning",
            ],
        },
    ];
    const trustFactors = [
        ...
        { title: "Value Realization & Continous Improvement", icon: TrendingUp, desc: "Focusing on tangible business outcomes and ROI." },
