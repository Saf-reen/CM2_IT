    ...
    const implementationSteps = [
        {
            ...
            bullets: [
                "Job posting and supplier engagement",
                "Rate and role benchmarking",
                "Time and expense tracking",
                "Compliance checks and onboarding workflows",
            ],
        },
        {
            title: "Services Procurement",
            bullets: [
                "Creation and management of SOWs",
                "Milestone and deliverable tracking",
                "Budgeting and invoicing controls",
                "Resource and engagement tracking",
            ],
        },
        {
            title: "Direct Sourcing",
            bullets: [
                "Lower cost and time-to-fill",
                "Engage known freelancers and alumni",
                "Integration with job boards and talent platforms",
            ],
        },
        {
            title: "Worker Profile Management",
            bullets: [
                "Maintain centralized worker profiles",
                "Credential and certification tracking",
                "Access management and risk mitigation",
            ],
        },
        {
        ...
        },
        {
            ...
            bullets: [
                ...
                "Rate negotiation and compliance",
                "Tiered supplier strategies",
            ],
        },
        {
            title: "Mobile and Integration Capabilities",
            bullets: [
                "Mobile app for approvals, time/expense entry",
                "Integrates with SAP S/4HANA, SuccessFactors, Ariba, and 3rd-party systems",
            ],
        },
        {
            ...
            bullets: [
                ...
                "Background checks, training verification",
