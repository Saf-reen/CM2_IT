...
const ProductLifeCycle = () => {
    ...
    const implementationSteps = [
        {
            title: "PLM Strategy & Roadmap",
            bullets: [
                "Assess current product development processes",
                "Define PLM strategy aligned with business goals",
                "Create a digital transformation roadmap with SAP PLM",
            ],
        },
        {
            title: "Implementation & Integration",
            bullets: [
                "SAP PLM core implementation (Part Management, Document Management, BOM Management)",
                "Integration with SAP S/4HANA, SAP ERP, SAP ECTR, Teamcenter, and CAD tools (NX, CATIA, SolidWorks)",
                "Engineering Change Management & Workflow automation",
                "Integration with Manufacturing Execution Systems (MES) and Supply Chain systems",
            ],
        },
        {
            title: "Engineering Collaboration & CAD Integration",
            bullets: [
                "SAP Engineering Control Center (ECTR) deployment",
                "Enable multi-CAD data management and visualization",
            ],
        },
        {
            title: "BOM Management (eBOM, mBOM, sBOM)",
            bullets: [
                "Engineering BOM (eBOM) and Manufacturing BOM (mBOM) harmonization",
                "BOM transformation and reconciliation across departments",
        ...
        },
        {
            ...
            bullets: [
                ...
                "Regulatory compliance management (REACH, RoHS, ISO, FDA, etc.)",
                "Audit trail and digital signatures",
            ],
        },
        {
            title: "Engineering Change & Configuration Management",
            bullets: [
                "End-to-end change management (ECR/ECO/ECR)",
                "Configuration management for product variants",
                "Impact analysis and cross-functional change coordination",
            ],
        },
        {
            title: "PLM Analytics & Reporting",
            bullets: [
                "Product performance insights",
                "KPI dashboards for R&D and engineering",
        ...
        },
        {
            ...
            bullets: [
                ...
                "PLM system upgrades, enhancements, and optimization",
    ...
    const trustFactors = [
        ...
        { title: "Value Realization & Continuous", icon: TrendingUp, desc: "Focusing on tangible business outcomes and ROI." },
