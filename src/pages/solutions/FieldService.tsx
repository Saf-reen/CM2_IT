    ...
    const implementationSteps = [
        {
            ...
            bullets: [
                ...
                "Business process evaluation & mapping (field operations, dispatching, mobile workforce)",
                "Fit-gap analysis with current systems (SAP ERP, S/4HANA, CRM, etc.)",
        ...
        },
        {
            ...
            bullets: [
                "FSM system configuration & setup",
                "Master data setup (equipment, materials, customers, workforce, service call types)",
                "Integration with SAP S/4HANA, ECC, C/4HANA, or other backend system",
                "Workflow design: service call, dispatching, execution, feedback, billing",
                "Dynamic forms and checklists for mobile apps",
                "Scheduling & dispatching setup using AI-based optimization",
        ...
        },
        {
            ...
            bullets: [
                "SAP ERP / S/4HANA Plant Maintenance (PM) or Customer Service (CS) integration",
                "CRM system integration (SAP Sales Cloud, Service Cloud, Salesforce, etc.)",
                "Mobile app integration (iOS, Android devices)",
                "Integration with workforce management and HR systems",
            ],
        },
        {
            title: "Custom Development & Extensions",
            bullets: [
                "Custom UI and mobile app enhancements",
                "Development of specific reports, KPIs, and dashboards",
                "Extensions using SAP Business Technology Platform (BTP)",
                "Offline mobile functionality customization",
            ],
        },
        {
            title: "Training & Change Management",
            bullets: [
                "End-user training (technicians, dispatchers, back-office staff)",
